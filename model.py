...
class InputEmbeddings(nn.Module):
    ...
    def forward(self, x) -> torch.Tensor:
        """
        Translates the tokenizer into it's embedding.
        """
...
class PositionalEncoding(nn.Module):
    ...
    def forward(self, x):
        ...
        given tokenizer, and applies dropout for regularization.
        """
...
class ProjectionLayer(nn.Module):
    """
    Class for handling the output of the transformer and converting it to the appropriate tokenizer.
    """
